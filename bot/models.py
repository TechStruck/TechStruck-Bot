...
class BotModel(Model):
    ...
    for_testing = fields.BooleanField(
        default=True, description="Whether the bot has been added by a user for testing")
    description = fields.CharField(
        max_length=200, description="Description of the bot")
    # Ownership
    user_owner = fields.ForeignKeyField(
        model_name="main.MemberModel", null=True, related_name="owned_bots", description="Owner of the bot")
    dev_team = fields.ForeignKeyField(
        model_name="main.TeamModel", null=True, related_name="team_owned_bots", description="The team that develops the bot")
...
class TeamModel(Model):
    ...
    admins = fields.ManyToManyField(
        model_name="main.MemberModel", related_name="administratored_teams", description="Admins of the team")
    members = fields.ManyToManyField(
        model_name="main.MemberModel", related_name="teams", description="All members of the team")
...
class ThankModel(Model):
    id = fields.IntField(pk=True)
    thanker = fields.ManyToManyField(
        model_name="main.MemberModel", related_name="sent_thanks", description="The member who sent the thanks")
    thanked = fields.ManyToManyField(
        model_name="main.MemberModel", related_name="thanks", description="The member who was thanked for the help")
